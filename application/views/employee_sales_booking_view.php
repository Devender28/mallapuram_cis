                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                        <div class="col-sm-10">
                           ...
                           Employee Sales Booking View
                            </h1>
                        </div>
                        
                        <div class="col-md-2">
                        <div class="col-xs-12">
                         <a href="<?php echo base_url('add_employee_sales_booking');?>"> <button class="btn btn-minw btn-danger" type="button">Add</button></a>
                           </div>
                           </div>
                            ...
                            <table class="display" id="example">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="font-w600">Mallapuram</td>
                                        <td class="hidden-xs">mallapuram@gmail.com</td>
                                       <td class="hidden-xs">1234567890</td>
...
<div class="col-md-6">
  ...
  <tr>
    <td width="10%"> 2</td>
    <td width="50%"> Select Insurance Company</td>
    <td width="40%"> <strong>Mallapuram </strong> </td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    <td width="10%"> 3</td>
    <td width="50%"> Select Insurance Policy Category</td>
...
<div class="col-md-6">
  ...
  <tr>
    <td width="10%"> 4</td>
    <td width="50%"> Select Policy Type</td>
    <td width="40%"> <strong>Life </strong> </td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    <td width="10%"> 5</td>
    <td width="50%"> Select Policy Name</td>
    <td width="40%"> <strong>mallapuram</strong></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>12345678 </strong> </td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>50.000</strong></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>30.000</strong></td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    <td width="10%"> 9</td>
    <td width="50%"> Tax Percentage (Premium Without Tax-Premium With Tax)</td>
    <td width="40%"> <strong>50%</strong></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>20.000</strong></td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>25-5-2005</strong></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>5 years</strong></td>
  </tr>
...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>2 years</strong></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"> <strong>Annual</strong></td>
  </tr>
  ...
  <tr>
    ...
    <td width="40%"> <strong>mallapuram</strong></td>
            ...
            <button  class="btn btn-xs btn-default"  data-toggle="modal" data-target="#modal-normal" type="button" title="View Details"><i class="fa fa-eye"></i></button>
                                <a href="#"> <button class="btn btn-xs btn-default" type="button"><i class="fa fa-pencil"></i></button></a>
