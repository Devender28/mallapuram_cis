                            ...
                            <table class="display" id="example">
                                <thead class="bg-info">
                                    <tr>
                                        ...
                                        <th class="hidden-xs">Policies</th>
...
$num_of_policies=$this->db->get_where('ind_policy',array('member_id' =>$registered_member->max_id))->num_rows();	
...
?>                                    
                                        ...
                                        <td class="hidden-xs">
                                       <a href="<?php echo base_url('admin/member_policies_report_details').'/'.$registered_member->max_id;?>"> 
                                        <span class="btn btn-sm btn-primary"><?php echo $num_of_policies;?></span> 
                                        </a>
