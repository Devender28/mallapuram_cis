...
?>                                    
                                        ...
                                        <tr>
                                         <td><?php echo $a;?></td>
                                         <td class="font-w600"><?php echo standard_date('DATE_RFC1123', strtotime($registered_member->crdate));?> </td>
                                <td class="hidden-xs"><?php echo $registered_member->first_name;?> <?php echo $registered_member->middle_name;?> <?php echo $registered_member->last_name;?></td>       
                                         <td class="hidden-xs"><?php echo $registered_member->email1;?></td>
       ...
       <td class="text-center">
           ...
           <button class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal-normal" type="button" onclick="view_registered_employee(<?php echo $registered_member->id;?>)" title="View Details"><i class="fa fa-eye"></i></button>
