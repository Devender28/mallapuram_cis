<main id="main-container">
                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                        ...
                        <div class="col-md-2">
                        <div class="col-xs-12">
                          <a href="<?php echo base_url('admin/account_statements');?>" class="btn btn-minw btn-danger" type="button">View</a>
                           </div>
                           </div>
...
<?php }?>                                                      
  ...
  <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9">
                                              <select class="js-select2 form-control" id="dev1" name="insurance_company_id" style="width: 100%;" data-placeholder="Choose one.." required>
...
<div class="col-md-6">
 <label class="col-xs-12" >Account Statement( Upload Pdf )</label>
<div class="col-sm-9">
    ...
    <div class="col-md-6">
        <div class="col-sm-9">
              ...
              <!-- <button class="btn btn-sm btn-primary" type="submit" name="add_corporate_employee">Add Employee</button>&nbsp;-->
               <button class="btn btn-sm btn-primary" type="submit" name="add_account_statement">Save & Add Pdf</button>
