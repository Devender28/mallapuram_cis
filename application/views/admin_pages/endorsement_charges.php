<main id="main-container">
                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                       ...
                       <div class="col-md-2">
                        <div class="col-xs-12">
                          <a href="<?php echo base_url('admin/add_endorsement_charges');?>" class="btn btn-minw btn-danger" type="button">Add</a>
                           </div>
                           </div> 
  ...
  <div class="form-group"> <hr> </div>
                                 ...
                                 <div class="col-md-12" id="devtitle"><h4>Endorsement Charges</h4><br>
                                   </div>
                                 </div>
...
foreach($endorsement_charges as $endorsement_charge){?>                                    
                                        ...
                                        <td class="text-center"><?php echo $this->fun->getnewfieldvalue("corporate_client","name","id",$endorsement_charge->corporate_id)?> </td>
