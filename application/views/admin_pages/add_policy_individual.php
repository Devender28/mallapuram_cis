                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                        <div class="col-sm-10">
                          ...
                          Add Policy to Individual
                            </h1> 
                        </div>
                        
                     <div class="col-md-2">
                        <div class="col-xs-12">
                          <a href="<?php echo base_url('admin/member_policies_report');?>"><button class="btn btn-minw btn-danger" type="button">Member Policies</button></a>
                           </div>
                           </div>  
                ...
                <div class="content content-narrow">
                   ...
                   <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group">
                                                <div class="col-md-6">
                    <label class="col-xs-12" for="example-text-input">Select Individual <span class="text-danger">*</span></label>
                                          <div class="col-sm-9">
            <select class="js-select2 form-control" id="val-select2" name="individual" required>
                                               
                                                    <option>Select Individual </option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                                    <?php foreach($registered_members as $member){ ?>

                                                    <option value="<?php echo $member->max_id;?>"><?php echo $member->first_name.' '.$member->middle_name.' '.$member->last_name;?></option>
                                                    <?php } ?>
            ...
            <select class="js-select2 form-control" id="val-select2" name="payment_mode" >
                                                    ...
                                                    <option>Select Premium Payment Mode </option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
             ...
             <select class="js-select2 form-control" id="val-select2" name="nominee3_relation" style="width: 100%;" data-placeholder="Choose one..">
              ...
              <input class="form-control" type="text" id="" name="nomination3_percentage" data-date-format="mm/dd/yy" placeholder=""></div>
                    ...
                    <button class="btn btn-md btn-primary" type="submit" name="add_ind_policy">Add Policy to Individual</button>
  ...
  <script type="text/javascript">
    function getPolicy(id){ 
     ...
     $.ajax({
 type: 'post',
 url: <?php echo '"'.base_url('admin/getIndPolicy').'"';?>,
 data: {
 id:id
