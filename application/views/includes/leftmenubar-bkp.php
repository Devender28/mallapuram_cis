...
<div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                      ...
                      <ul class="nav-main">
                                <li>
                                   <a href="<?php echo base_url();?>admin/dashboard"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                          ...
                          <li class="open">
                               ...
                               <ul>
                                  ...
                                  <li>
                                    <a href="<?php echo base_url('admin/insurance_companies');?>" class="<?php if($this->uri->segment(1)=='insurance_companies') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Insurance Companies</span></a>
                                </li>
                                
                                       
                                
                                  <li>
                                    <a href="<?php echo base_url('admin/insurance_policy_type');?>" class="<?php if($this->uri->segment(2)=='insurance_policy_type') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Insurance Policy Types</span></a>
                                </li>
                                
                                
                                
                                <li>
                                    <a href="<?php echo base_url('admin/insurance_policies');?>" class="<?php if($this->uri->segment(2)=='insurance_policies') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Insurance Policy Name</span></a>
                                </li>
...
<li class="open">
 ...
 <ul>
                             ...
                             <li>
                                    <a href="<?php echo base_url('admin/cd_account_details');?>" class="<?php if($this->uri->segment(2)=='cd_account_details' or  $this->uri->segment(2)=='cd_account_details' or $this->uri->segment(2)=='cd_account_details') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">CD Account List</span></a>
...
<li>
                              ...
                              <li>
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/add_endorsement_charges');?>" class="<?php if($this->uri->segment(2)=='add_endorsement_charges' or  $this->uri->segment(2)=='add_endorsement_charges' or $this->uri->segment(2)=='add_endorsement_charges') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Add Endorsement Charges</span></a>
                                 ...
                                 <li>
                                    <a href="<?php echo base_url('admin/endorsement_charges');?>" class="<?php if($this->uri->segment(2)=='endorsement_charges' or  $this->uri->segment(2)=='add_endorsement_charges' or $this->uri->segment(2)=='add_endorsement_charges') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Endorsement Charges List</span></a>
 ...
 <ul>
          ...
          <li>
         <a href="<?php echo base_url('admin/employees_addition');?>" class="<?php if($this->uri->segment(2)=='employees_addition' or  $this->uri->segment(2)=='employees_addition' or $this->uri->segment(2)=='employees_addition') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Employees Addition</span></a>
         </li> 
         ...
         <li>
      <a href="<?php echo base_url('admin/employees_deletion');?>" class="<?php if($this->uri->segment(2)=='employees_deletion' or  $this->uri->segment(2)=='employees_deletion' or $this->uri->segment(2)=='employees_deletion') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Employees Deletion</span></a>
        </li>  
                                
                                
                                
        <li>
        <a href="<?php echo base_url('admin/employees_deleted');?>" class="<?php if($this->uri->segment(2)=='employees_deleted' or  $this->uri->segment(2)=='employees_deleted' or $this->uri->segment(2)=='employees_deleted') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Deleted Employees</span></a>
        </li>    
...
<li class="open">
 ...
 <ul>
                               ...
                               <li>
                                    <a href="<?php echo base_url('admin/add_claim_dump');?>" class="<?php if($this->uri->segment(2)=='add_claim_dump' or  $this->uri->segment(2)=='add_claim_dump' or $this->uri->segment(2)=='add_claim_dump') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Claim Dump</span></a>
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/claim_dump');?>" class="<?php if($this->uri->segment(2)=='claim_dump' or  $this->uri->segment(2)=='claim_dump' or $this->uri->segment(2)=='claim_dump') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Claim Dump List</span></a>
     ...
     <li class="<?php if($this->uri->segment(2)=='add_mallapuram_employee' || $this->uri->segment(2)=='all_mallapuram_employee') echo 'open';?>">
...
<li class="open">
 ...
 <ul>
                               ...
                               <li>
                                    <a href="<?php echo base_url('admin/registered_members');?>" class="<?php if($this->uri->segment(2)=='registered_members' or  $this->uri->segment(2)=='registered_members' or $this->uri->segment(2)=='registered_members') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Registered Members</span></a>
                                 ...
                                 <li>
                                    <a href="<?php echo base_url('admin/family_member_reports');?>" class="<?php if($this->uri->segment(2)=='family_member_reports' or  $this->uri->segment(2)=='family_member_reports' or $this->uri->segment(2)=='family_member_reports') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Family Members reports</span></a>
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/member_policies_report');?>" class="<?php if($this->uri->segment(2)=='member_policies_report' or  $this->uri->segment(2)=='member_policies_report' or $this->uri->segment(2)=='member_policies_report') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Member Policies</span></a>
...
<li class="open">
 ...
 <ul>
                        ...
                        <li>
                                    <a href="<?php echo base_url('admin/promotion_interested');?>" class="<?php if($this->uri->segment(2)=='promotion_interested' or  $this->uri->segment(2)=='promotion_interested' or $this->uri->segment(2)=='promotion_interested') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">promotion Interested List</span></a>
