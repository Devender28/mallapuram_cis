...
<div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                <li>
                                   <a href="<?php echo base_url('hr/dashboard');?>" class="<?php if($this->uri->segment(2)=='dashboard') echo 'active';?>"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                              
                             <li>

                              <li>
                                    <a href="<?php echo base_url('hr/profile');?>" class="<?php if($this->uri->segment(2)=='profile') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Company Profile</span></a>
                                </li>
                                
                                
                                   <li class="<?php if($page=='employees_list') echo 'open';?>">
                           <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Employees List</span></a>
                               ...
                               <ul>
                                 ...
                                 <li class="<?php if($page=='policy_list') echo 'open';?>">
                           <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Policies List</span></a>
                       ...
                       <li class="<?php if($page=='endorsement') echo 'open';?>">
                           <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Endorsement Request</span></a>
                              ...
                              <li class="<?php if($page=='processed_endorsement_list') echo 'open';?>">
                           <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Processed Endorsements List</span></a>
                                    
                               <ul>
                                 <li>
                                    <a href="<?php echo base_url('hr/processed_endorsement_list');?>" class="<?php if($this->uri->segment(2)=='processed_endorsement_list') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Processed Endorsements</span></a>
                                </li>
                          ...
                          <li class="<?php if($page=='cdstatements') echo 'open';?>">
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">CD Statements</span></a>
                          ...
                          <li class="<?php if($page=='claimsdump' || $page=='claimintimation' || $page=='claimintimation_list' || $page=='claimintimation_company' || $page=='claimintimation_list_company') echo 'open';?>">
...
<li>
  ...
  <li class="<?php if($page=='cdamount') echo 'open';?>">
                         ...
                         <!--  <li class="<?php if($this->uri->segment(2)=='addition_request') echo 'open';?>">
                                ...
                                <li class="<?php if($this->uri->segment(2)=='claims_intimation' || $this->uri->segment(2)=='corrections_view') echo 'open';?>">
                                 ...
                                 <li class="<?php if($page=='feedback' || $page=='feedback_details') echo 'open';?>">
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Feedbak</span></a>
                                    
                               <ul>
                                <li>
                                    <a href="<?php echo base_url('hr/feedback');?>" class="<?php if($this->uri->segment(2)=='feedback') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Give Feedback</span></a>
                                </li>

                                <li>
                                    <a href="<?php echo base_url('hr/feedback_details');?>" class="<?php if($this->uri->segment(2)=='feedback_details') echo 'active';?>"><i class="si si-grid"></i><span class="sidebar-mini-hide">Feedback List</span></a>
                                </li>
