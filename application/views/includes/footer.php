   ...
   <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
                 <div class="col-md-9">
                  Copyright © <?php echo @date('Y');?>. Mallapuram All reserved 
                    
                </div>
                <div class="col-md-3">
                   Powerd  by <a href="http://elefontdesign.com" target="_blank"><img src="<?php echo base_url('assets/img/elefont_icon.png');?>"> Elefont Design</a>
                </div>
            </footer>
