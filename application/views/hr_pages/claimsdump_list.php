                             ...
                             <table class="display" id="deva">
                                <thead class="bg-warning">
                                    <tr>
                                        ...
                                        <th>Date</th>
                                        <th class="hidden-xs">Claims Dump File</th>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                       ...
                                       <td class="hidden-xs"><a href="<?php echo base_url('uploads/claim_dump').'/'.$cd->pdf;?>" download><button  class="btn btn-md btn-info fa fa-download "></button></a></td>
