                             ...
                             <table class="display" id="deva">
                                <thead class="bg-warning">
                                    <tr>
                                        ...
                                        <th class="hidden-xs" style="width: 15%;">Designation</th>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600"><?php echo $emp->employee_id;?></td>
                                        <td class="font-w600"><?php echo $emp->name;?></td>
                                        <td class="hidden-xs"><?php echo $emp->email;?></td>
                                       <td class="hidden-xs"><?php echo $emp->phone;?></td>
                                       <td class="hidden-xs"><?php echo $emp->designation;?></td>
                                       
                                        <td> <button  class="btn btn-xs btn-info "  data-toggle="modal" data-target="#modal-normal" type="button" onclick="view_employee(<?php echo $emp->id;?>)" title="View Details"><i class="fa fa-eye"></i></button></td>
                                    </tr>
