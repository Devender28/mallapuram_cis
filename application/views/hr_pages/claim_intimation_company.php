                ...
                <div class="content content-narrow">
                   ...
                   <form class="js-validation-bootstrap form-horizontal" action="" method="post" >
                                  ...
                                  <div class="form-group"> 
                                            ...
                                            <div class="col-md-12">
                                                <label class="col-xs-12">Date of Incident</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-md-12">
                                               <label class="col-xs-12">Incident Description</label>
                                                <div class="col-sm-9">
                                                 <textarea class="form-control" rows="10" required name="hosp_reason" ></textarea>
                                     ...
                                     <div class="form-group">
                                       <div class="col-xs-3"></div>
                                        <div class="col-xs-5">
                                           ...
                                           <input type="submit" class="btn btn-minw btn-danger" value="Submit" name="claim_intimation_company">
