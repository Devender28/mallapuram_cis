...
<div class="form-group">
 <div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"><a  href="<?php echo base_url('uploads/sales/'.$sale->policy_copy);?>"  target="_blank"><button class="btn btn-md btn-info fa fa-download "></button></a></td>
  </tr>
...
<div class="col-md-6">
  ...
  <tr>
    ...
    <td width="40%"><a  href="<?php echo base_url('uploads/sales/'.$sale->policy_benefits);?>" target="_blank"><button class="btn btn-md btn-info fa fa-download "></button></a></td>
  </tr>
