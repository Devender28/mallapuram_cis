...
<div class="healthcard">
  ...
  <div class="title">Mallapuram Health Insurance</div>
  <div class="healthcard-details">
    <div class="label">Product Name</div>
    <div class="details">Group Health Insurance</div>
  </div>
  ...
  <div class="healthcard-details">
    ...
    <div class="details">000000000000000000</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
  ...
  <div class="healthcard-details">
    ...
    <div class="details">Mahesh Chintalapati</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
    <div class="label">Member ID</div>
    <div class="details">SBIG12345678</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
    <div class="label">Start Date</div>
    <div class="details">26/06/2018</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
    <div class="label">Member Relation</div>
    <div class="details">Self</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
    <div class="label">Gender</div>
    <div class="details">Male</div>
  </div>
  <div class="clearboth"></div>
  <div class="healthcard-details">
    <div class="label">Date Of Birth, Age</div>
    <div class="details">05/09/1978, 35</div>
  </div>
  <div class="clearboth"></div>
  <div class="strip"></div>
</div>
