...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content overflow-hidden">
            ...
            <input class="form-control" type="password" id="example-text-input" name="new_password"  required>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div align="center" class="col-xs-12"><br>
                                        ...
                                        <button class="btn btn-danger" type="submit" name="fpassword"><i class="fa fa-plus pull-right"></i> Change Password</button>
