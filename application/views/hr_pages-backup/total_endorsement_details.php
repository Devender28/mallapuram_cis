                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                      ...
                      Total Endorsement Details
                        ...
                        <div class="col-md-2">
                        <div class="col-xs-12">
                        <!-- <a href="#"> <button class="btn btn-minw btn-danger" type="button">Add</button></a> -->
                           </div>
                           </div>
  ...
  <tr>
    ...
    <td width="40%"> <strong>mallapuram</strong></td>
            ...
            <button  class="btn btn-xs btn-default"  data-toggle="modal" data-target="#modal-normal" type="button" title="View Details"><i class="fa fa-eye"></i></button>
                                <a href="sales-booking-edit.php"> <button class="btn btn-xs btn-default" type="button"><i class="fa fa-pencil"></i></button></a>
