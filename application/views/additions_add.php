            ...
            <main id="main-container">
                ...
                <div class="content bg-gray-lighter3">
                    <div class="row items-push">
                        ...
                        <div class="col-md-2">
                        <div class="col-xs-12">
                          <a href="addition_view.php"><button class="btn btn-minw btn-danger" type="button">View</button></a>
                           </div>
                           </div>
             ...
             <label class="control-label" for="val-select2">Select Policy</label>
                          ...
                          <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9">
                                           <input class="form-control" type="text" id="example-text-input" name="example-text-input" ></div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                     <div class="col-xs-5"></div>
                                            <div class="col-xs-7">
                                               ...
                                               <a href="addition_view.php"> <button class="btn btn-minw btn-danger" type="button">Submit</button></a>
