  ...
  <form class="form-horizontal" action="" method="post">                   
             ...
             <label class="control-label" for="val-select2">First Name</label>
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="first_name_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="first_name_radio" checked="checked"><span></span> No
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="middle_name_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="middle_name_radio"  checked="checked"><span></span> No
                                            </label>
                                          </div>
                                          </div>
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="last_name_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="last_name_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                      ...
                                      <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="email1_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="email1_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="email2_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="email2_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="mobile1_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio"  value="No"  checked name="mobile1_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                     ...
                                     <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="mobile2_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio"  value="No"  checked name="mobile2_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                     ...
                                     <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="mobile3_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="mobile3_radio"><span></span> No
                                            </label>
                                          </div>
                                         </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="recorded_dob_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="recorded_dob_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="actual_dob_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="actual_dob_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="aadhar_no_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="aadhar_no_radio"><span></span> No
                                            </label>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="aadhar_scan_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked  name="aadhar_scan_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                            <label>Pan No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="pan_no" value="<?php echo $profile_info->pan_no;?>" readonly>
                                     </div>
                                     ...
                                     <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="pan_no_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="pan_no_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="pan_scan_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="pan_scan_radio"><span></span> No
                                            </label>
                                          </div>
                                   ...
                                   <div class="form-group">
                                    <div class="col-md-8">
                                       ...
                                       <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="voterid_no_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="voterid_no_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="voterid_scan_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="voterid_scan_radio"><span></span> No
                                            </label>
                                          </div>
                            ...
                            <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio"  value="Yes" name="license_no_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="license_no_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                      ...
                                      <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="license_expiry_date_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="license_expiry_date_radio"><span></span> No
                                            </label>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="license_scan_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="license_scan_radio"><span></span> No
                                            </label>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="passport_no_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="passport_no_radio"><span></span> No
                                            </label>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="passport_expiry_date_radio"><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="passport_expiry_date_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio"  value="Yes" name="passport_scan_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="passport_scan_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="state_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="state_radio"><span></span> No
                                            </label>
                                          </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes"  name="district_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="district_radio"><span></span> No
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-md-8">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="address_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked name="address_radio"><span></span> No
                                            </label>
                                          </div>
                                            </div>
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <div class="col-md-4">
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" value="Yes" name="pincode_radio" ><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" value="No"  checked  name="pincode_radio"><span></span> No
                                            </label>
                                          </div>
...
<div class="row">
                        ...
                        <div class="col-md-1"><input class="btn btn-minw btn-primary" type="submit" value="DONE" name="profile_check_done"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-success" type="submit" value="SKIP" name="profile_check_skip"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-warning" type="submit" value="Postpone" name="postpone_done"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-danger" type="submit" value="ESCALATE" name="profile_check_escalate"></div>
                        <br>
<br>
 </form>
