 <?php  $checking_info=$this->db->get_where('check_family_registration',array('ticket_id'=>$info->ticket_id))->row(); ?>
                     ...
                     <div class="col-lg-4" >
                      ...
                      <div class="col-lg-4" style="background-color:#F7E9C8;">
                          ...
                          <div class="col-md-12">
                                                ...
                                                <input class="form-control" type="text" id="example-text-input" name="relationship" value="<?php echo $family_profile_info->relationship;?>" <?php if($checking_info->relationship=="Yes"){ echo "readonly";}?>>
                                         ...
                                         <label class="css-input css-radio css-radio-primary push-10-r">
                                                <input type="radio" name="relationship_radio" value="Yes" <?php if($checking_info->relationship=="Yes"){ echo "checked";}?>><span></span> Yes
                                            </label>
                                            <label class="css-input css-radio css-radio-primary">
                                                <input type="radio" name="relationship_radio" value="No" <?php if($checking_info->relationship=="No"){ echo "checked";}?>><span></span> No
                                            </label>
                                   ...
                                   <label >First Name</label>
                                                ...
                                                <input class="form-control" type="text" id="example-text-input" name="first_name" value="<?php echo $family_profile_info->first_name;?>" <?php if($checking_info->first_name=="Yes"){ echo "readonly";}?>> 
                                    ...
                                    <div class="col-md-8">
                                            <label> Middle Name</label>
                                          <input class="form-control" type="text" id="example-text-input" name="middle_name" value="<?php echo $family_profile_info->middle_name;?>" <?php if($checking_info->middle_name=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label >Last Name</label>
                                           <input class="form-control" type="text" id="example-text-input" name="last_name" value="<?php echo $family_profile_info->last_name;?>" <?php if($checking_info->last_name=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Mobile 1</label>
                                          <input class="form-control" type="text" id="example-text-input" name="mobile1" value="<?php echo $family_profile_info->mobile1;?>" <?php if($checking_info->mobile1=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Mobile 2</label>
                                          <input class="form-control" type="text" id="example-text-input" name="mobile2" value="<?php echo $family_profile_info->mobile2;?>" <?php if($checking_info->mobile2=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Mobile 3</label>
                                          <input class="form-control" type="text" id="example-text-input" name="mobile3" value="<?php echo $family_profile_info->mobile3;?>" <?php if($checking_info->mobile3=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Date of Birth (Recorded)</label>
                                          <input class="form-control" type="text" id="example-text-input" name="recorded_dob" value="<?php echo $family_profile_info->recorded_dob;?>" <?php if($checking_info->recorded_dob=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Date of Birth (Actual)</label>
                                          <input class="form-control" type="text" id="example-text-input" name="actual_dob" value="<?php echo $family_profile_info->actual_dob;?>" <?php if($checking_info->actual_dob=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Aadhar No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="aadhar_no" value="<?php echo $family_profile_info->aadhar_no;?>" <?php if($checking_info->aadhar_no=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Pan No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="pan_no" value="<?php echo $family_profile_info->pan_no;?>" <?php if($checking_info->pan_no=="Yes"){ echo "readonly";}?>>
                                     </div>
                                    ...
                                    <div class="col-md-8">
                                            <label>Voterid No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="voterid_no" value="<?php echo $family_profile_info->voterid_no;?>" <?php if($checking_info->voterid_no=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Driving License No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="license_no" value="<?php echo $family_profile_info->license_no;?>" <?php if($checking_info->license_no=="Yes"){ echo "readonly";}?>>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                            <label>Driving License Expiry Date</label>
                                          <input class="form-control" type="text" id="example-text-input" name="license_expiry_date" value="<?php echo $family_profile_info->license_expiry_date;?>" <?php if($checking_info->license_expiry_date=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Passport No</label>
                                          <input class="form-control" type="text" id="example-text-input" name="passport_no" value="<?php echo $family_profile_info->passport_no;?>" <?php if($checking_info->passport_no=="Yes"){ echo "readonly";}?>>
                                    ...
                                    <div class="col-md-8">
                                            <label>Passport Expiry Date</label>
                                          <input class="form-control" type="text" id="example-text-input" name="passport_expiry_date" value="<?php echo $family_profile_info->passport_expiry_date;?>" <?php if($checking_info->passport_expiry_date=="Yes"){ echo "readonly";}?>>
...
<div class="row">
                        ...
                        <div class="col-md-1"><input class="btn btn-minw btn-primary" type="submit" value="DONE" name="family_profile_update_done"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-success" type="submit" value="SKIP" name="family_profile_update_skip"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-warning" type="submit" value="Postpone" name="postpone_done"></div>
                        
                        <div class="col-md-1"><input class="btn btn-minw btn-danger" type="submit" value="ESCALATE" name="family_profile_update_escalate"></div>
                        <br>
<br>
