 ...
 <iframe src="<?php echo base_url().'individual/uploads/individual/policies/'.$policy_info->policy_copy;?>" width="350" height="400"></iframe>
                                ...
                                <div class="block-content block-content-full" >
                                    ...
                                    <div data-toggle="slimscroll" data-height="500px" data-color="#333333" data-always-visible="true">
                                      ...
                                      <div class="row">
                                        ...
                                        <img src="images/pan2.jpg" width="450" height="300">
                                        </div>
                                      ...
                                      <div class="row" style="margin-top:50px;">
                                         <div class="form-group">
                                          ...
                                          <img src="images/voter.jpg" width="450" height="300">
                                          </div>
...
<br>
                         ...
                         <div class="col-md-12">
                          ...
                          <div class="col-md-3"><input class="btn btn-minw btn-primary" type="submit" value="DONE" name="policy_check_done"></div>
                          
                          <div class="col-md-3"><input class="btn btn-minw btn-success" type="submit" value="SKIP" name="policy_check_skip"></div>
                          
                           <div class="col-md-3"><input class="btn btn-minw btn-warning" type="submit" value="POSTPONE" name="policy_check_postpone"></div>
                         
                          <div class="col-md-3"><input class="btn btn-minw btn-danger" type="submit" value="ESCALATE" name="policy_check_escalate"></div>
                      ...
                      <div class="col-lg-3">
                         <div class="col-lg-12" style="background-color:#F7E9C8;">
                          
                            <br>

                                     <h3  style="font-size:26px; border-bottom: solid #CCC 1px;">Create Endorsment Ticket </h3>
                            <div class="block-content block-content-full">
                                <!-- SlimScroll Container -->
                                 <div data-toggle="slimscroll" data-height="220px" data-color="#333333" data-always-visible="true">
                                    <form class="form-horizontal" action="" method="post" >
                             ...
                             <!--   <div class="col-lg-3" style=" margin-top:20px;">
                                      ...
                                      <div class="block" style="background-color:#F7E9C8;">
                                          <div class="block-header">
                                               <h3  style="font-size:22px; border-bottom: solid #CCC 1px;">Create Family member Ticket </h3>
                                          </div>
                                                  ...
                                                  <div class="form-group">
                                                   ...
                                                   <div class="col-md-12">
                                                     ...
                                                     <div class="form-group">
                                                      <div class="col-md-12">
                                                        <label>Correction Data</label>
                                                       <textarea class="form-control" type="text" id="example-text-input" name="insurance" placeholder="Correction Data"> </textarea>
                                                       <br>
