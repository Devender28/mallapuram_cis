...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content overflow-hidden">
            ...
            <input class="form-control" type="text" id="example-text-input" name="middle_name" required>
            ...
            <input class="form-control" type="text" id="example-text-input" name="last_name" required></div>
            ...
            <input class="form-control" type="text" id="example-text-input" name="username" required>
            ...
            <input class="form-control" type="password" id="example-text-input" name="password" required>
                                ...
                                <div class="form-group">
                                    <div align="center" class="col-xs-12"><br>
                                        ...
                                        <button class="btn btn-danger" type="submit" name="register"><i class="fa fa-plus pull-right"></i> Sign Up</button>
                                        
                                       
                                    <a href="<?php echo base_url();?>" data-toggle="tooltip" data-placement="right" title="Log In" style="float:right;  margin-right:30px;"><i class="si si-login"> Log In</i></a>
