            ...
            <input class="form-control" type="text" id="" name="first_name" value="<?php echo $member->first_name;?>" >
              ...
              <input class="form-control" type="text" id="example-text-input" name="mobile2"  value="<?php echo $member->mobile2;?>"></div>
                ...
                <input class="form-control" type="text" id="example-text-input" name="username" value="<?php echo $member->username;?>" readonly>   
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9">
             <input class="js-datepicker form-control" type="text" id="example-datepicker1" name="r_dob" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="<?php echo $member->recorded_dob;?>"> </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9">
              <input class="js-datepicker form-control" type="text" id="example-datepicker1" name="a_dob" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="<?php echo $member->actual_dob;?>"></div>
             ...
             <input class="form-control" type="text" id="example-text-input" name="license_no" value="<?php echo $member->license_no;?>" >   </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9">
              <input class="js-datepicker form-control" type="text" id="example-datepicker1" name="license_expiry" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" value="<?php echo $member->license_expiry_date;?>"> </div>
